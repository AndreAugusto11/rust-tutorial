...
pub fn create_truck(
    ...
    // Truck::new(id, is_available, is_active, maintenance_every, total_distance, consumption, tank_capacity)
}

impl MotorVehicle for Truck {
    fn get_id(&self) -> i32 {
        self.id
    }
    ...
    fn to_string(&self) -> String {
        format!("Truck id: {}, is_available: {}, is_active: {}, maintenance_every: {}, total_distance: {}, consumption: {}, tank_capacity: {}", self.id, self.is_available, self.is_active, self.maintenance_every, self.total_distance, self.consumption, self.tank_capacity)
    }
}
